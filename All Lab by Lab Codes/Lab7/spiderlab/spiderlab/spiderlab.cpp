...
public:
	...
	Spider(Point2 pos) {
		...
		string fname[2] = { "C:\\Users\\Koln1ce\\Desktop\\Computer Graphics\\spiderlab\\spider1.bmp", "C:\\Users\\Koln1ce\\Desktop\\Computer Graphics\\spiderlab\\splash.bmp" }; // Replace with actual image filenames
		for (int i = 0; i < 2; i++) {
...
//	updateBullet();
//
//	// Update spider's position here
//	if (spider.isMoving) {
//		spider.changePosition(spider.spiderSpeed * cos(spider.theta), spider.spiderSpeed * sin(spider.theta));
//	}
//
//	spider.render();
//	bullet.render();
//	glFlush();
//
//	// Call glutPostRedisplay to continuously render the scene
//	glutPostRedisplay();
//}
